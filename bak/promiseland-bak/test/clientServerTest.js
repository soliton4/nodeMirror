...
var __requireFun = function(parModule){
    ...
    if (promiseland._hasModule({ hashStr: "222cd65c51e7665072e3ff3ecae97b1b" })){ return promiseland._getModule("222cd65c51e7665072e3ff3ecae97b1b"); };
var PL$1 = new __Promise();
promiseland._registerModule({ hashStr: "222cd65c51e7665072e3ff3ecae97b1b", "module": PL$1, promising: true });
...
PL$3/*promiseland exception catcher*/(function(){
  ...
  PL$28/*mainio*/["on"]("connection", (function(PL$29/*socket*/){
    ...
    return;
    ;}));
  __requireFun("./testmodules/syncEvents").then(PL$3/*promiseland exception catcher*/(function(PL$31){PL$31;
