...
if (promiseland._hasModule({ hashStr: "367388894588dfac0390ede580e7148f" })){ return promiseland._getModule("367388894588dfac0390ede580e7148f"); };
var PL$1 = new __Promise();
promiseland._registerModule({ hashStr: "367388894588dfac0390ede580e7148f", "module": PL$1, promising: true });
var PL$2 = (function(){
"use strict";
...
promiseland.registerRemote("server", "367388894588dfac0390ede580e7148f", "PL$20", f, (classSystem.createFunctionType({ "return": PL$6/*type:C1**/, arguments: [classSystem.getBuiltinType("var")]})));
...
return function(){
return promiseland.remoteExec("367388894588dfac0390ede580e7148f", "PL$20", arguments);
}
};
...
promiseland.registerRemote("server", "367388894588dfac0390ede580e7148f", "PL$26", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return function(){
var i = 0; var l = arguments.length; var newArgs = [undefined];
for(i = 0; i < l; ++i){ newArgs.push(arguments[i]); };
...
return function(){
return promiseland.remoteExec("367388894588dfac0390ede580e7148f", "PL$26", arguments);
}
};
...
PL$9/*promiseland exception catcher*/(function(){
  ...
  var PL$36 = new __Promise();if(PL$28/*isClient*/){
    PL$29/*f*/().then(PL$9/*promiseland exception catcher*/(function(PL$37){PL$37;
  ...
  ;
  PL$21/*check*/().then(PL$9/*promiseland exception catcher*/(function(PL$39){if(PL$39){
    PL$1.resolve({
      "success": true
    }); return;
  };
