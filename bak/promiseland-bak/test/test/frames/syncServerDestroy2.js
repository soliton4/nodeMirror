...
promiseland.registerRemote("server", "316f7703caae55c1b409374995265da1", "PL$20", f, (classSystem.createFunctionType({ "return": PL$6/*type:C1**/, arguments: [classSystem.getBuiltinType("var")]})));
...
return function(){
return promiseland.remoteExec("316f7703caae55c1b409374995265da1", "PL$20", arguments);
}
};
...
promiseland.registerRemote("server", "316f7703caae55c1b409374995265da1", "PL$26", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return function(){
var i = 0; var l = arguments.length; var newArgs = [undefined];
for(i = 0; i < l; ++i){ newArgs.push(arguments[i]); };
...
return function(){
return promiseland.remoteExec("316f7703caae55c1b409374995265da1", "PL$26", arguments);
}
};
