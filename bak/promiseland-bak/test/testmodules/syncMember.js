...
promiseland.registerRemote("server", "f6eb2f32b4cecef1b45032dd98625bfa", "PL$27", f, (classSystem.createFunctionType({ "return": classSystem.getBuiltinType("var"), arguments: [PL$6/*type:C2*/]})));
...
return function(){
return promiseland.remoteExec("f6eb2f32b4cecef1b45032dd98625bfa", "PL$27", arguments);
}
};
...
promiseland.registerRemote("server", "f6eb2f32b4cecef1b45032dd98625bfa", "PL$33", f, classSystem.getBuiltinType("var"));
if (promiseland.profileHas("server")){
return function(){
var i = 0; var l = arguments.length; var newArgs = [undefined];
for(i = 0; i < l; ++i){ newArgs.push(arguments[i]); };
...
return function(){
return promiseland.remoteExec("f6eb2f32b4cecef1b45032dd98625bfa", "PL$33", arguments);
}
};
...
PL$9/*promiseland exception catcher*/(function(){
  ...
  promiseland.registerRemote("server", "f6eb2f32b4cecef1b45032dd98625bfa", "PL$20", f, classSystem.getBuiltinType("var"));
  if (promiseland.profileHas("server")){
  return function(){
  var i = 0; var l = arguments.length; var newArgs = [undefined];
  for(i = 0; i < l; ++i){ newArgs.push(arguments[i]); };
  ...
  return function(){
  return promiseland.remoteExec("f6eb2f32b4cecef1b45032dd98625bfa", "PL$20", arguments);
  }
  };
  })(function(PL$15/*session*/){
