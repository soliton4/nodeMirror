...
Start
  = __ program:Program __ { return posRes(program); } // promiseland
...
RequireToken    = "require"    !IdentifierPart   // promiseland
...
//VarToken        = "var"        !IdentifierPart  // promiseland
...
PrimaryExpression
  ...
  / ArrayLiteral
  / ObjectLiteral
  / "(" __ expression:Expression __ ")" { return posRes(expression); } // promiseland
...
CallExpression
  = first:(
    ...
    rest:(
        __ profileArguments:ProfileArguments? __ args:Arguments { // promiseland
          return posRes({ 
            type: "CallExpression", 
            arguments: args,
            profileArguments: profileArguments  // promiseland
...
IterationStatement
  ...
  / ForToken __
    "(" __
    init:VariableStatementCore __ ";" __ // promiseland
    test:(Expression __)? ";" __
    update:(Expression __)?
    ")" __
    body:Statement
  ...
  / ForToken __
    "(" __
    left:VariableStatementCoreSingle __ // promiseland
    InToken __
    right:Expression __
    ")" __
    body:Statement
