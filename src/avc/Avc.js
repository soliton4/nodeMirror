...
helperDefine(["avc/avc-codec", "avc/util"], function(Module, _util){
...
var Avc = (function avc() {
  ...
  function constructor(parConfig) {
    parConfig = parConfig || {};
    ...
    window._broadwayOnPictureDecoded = function ($buffer, width, height) {
      ...
      var asm = getAsm(width, height);
      asm.inp.set(buffer);
      asm.doit();
      
      var copyU8 = new Uint8Array(asm.outSize);
      copyU8.set( asm.out );
