...
var _Master = {
  ...
  , newTerminal: function(parCallback){
    ...
    setTimeout(function(){
      parCallback(term);
      self._emitListChange();
    }, 0);
  }
  
  , _emitListChange: function(){
    //console.log("emmiting lc");
    var l = this._on.listChange.length;
    var i = 0;
    for (i; i < l; ++i){
      try{
        this._on.listChange[i]();
      }catch(e){};
    };
  }
  ...
  , onListChange: function(parFun){
    this._on.listChange.push(parFun);
  }
